...
$sql_tableau = "SELECT * FROM `SHT2` ORDER BY `SHT2`.`TIME` DESC LIMIT 100";
$sql_time = "SELECT TIME FROM `SHT2` ORDER BY `SHT2`.`TIME` DESC LIMIT 100";
$sql_temp = "SELECT temp FROM `SHT2` ORDER BY `SHT2`.`TIME` DESC LIMIT 100";
$sql_hum = "SELECT hum FROM `SHT2` ORDER BY `SHT2`.`TIME` DESC LIMIT 100";
