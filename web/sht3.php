...
$sql_tableau = "SELECT * FROM `SHT3` ORDER BY `SHT3`.`TIME` DESC LIMIT 100";
$sql_time = "SELECT TIME FROM `SHT3` ORDER BY `SHT3`.`TIME` DESC LIMIT 100";
$sql_temp = "SELECT temp FROM `SHT3` ORDER BY `SHT3`.`TIME` DESC LIMIT 100";
$sql_hum = "SELECT hum FROM `SHT3` ORDER BY `SHT3`.`TIME` DESC LIMIT 100";
