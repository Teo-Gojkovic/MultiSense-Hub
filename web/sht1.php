...
$sql_tableau = "SELECT * FROM `SHT1` ORDER BY `SHT1`.`TIME` DESC LIMIT 100";
$sql_time = "SELECT TIME FROM `SHT1` ORDER BY `SHT1`.`TIME` DESC LIMIT 100";
$sql_temp = "SELECT temp FROM `SHT1` ORDER BY `SHT1`.`TIME` DESC LIMIT 100";
$sql_hum = "SELECT hum FROM `SHT1` ORDER BY `SHT1`.`TIME` DESC LIMIT 100";
